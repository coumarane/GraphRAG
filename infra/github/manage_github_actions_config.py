...
WORKFLOW_ENTRIES: tuple[ConfigEntry, ...] = (
    ...
    ConfigEntry(
        ...
        scope="env-secret",
        environment="dev",
        description="Azure workload identity application client ID used by the OVH and Azure Terraform workflows.",
        required_by=("run-ovh-terraform-reinstall.yml", "run-azure-terraform.yml"),
    ),
    ConfigEntry(
    ...
    ConfigEntry(
        ...
        scope="env-var",
        environment="dev",
        description="Azure subscription ID used by the OVH and Azure Terraform workflow backends and providers.",
        required_by=("run-ovh-terraform-reinstall.yml", "run-azure-terraform.yml"),
    ),
    ConfigEntry(
        ...
        scope="env-var",
        environment="dev",
        description="Azure tenant ID used by the OVH and Azure Terraform workflow backends and providers.",
        required_by=("run-ovh-terraform-reinstall.yml", "run-azure-terraform.yml"),
    ),
    ConfigEntry(
        ...
        scope="env-var",
        environment="dev",
        description="Azure resource group that contains the Terraform state storage account for OVH and Azure stacks.",
        required_by=("run-ovh-terraform-reinstall.yml", "run-azure-terraform.yml"),
    ),
    ConfigEntry(
        ...
        scope="env-var",
        environment="dev",
        description="Azure storage account that contains the Terraform state containers for OVH and Azure stacks.",
        required_by=("run-ovh-terraform-reinstall.yml", "run-azure-terraform.yml"),
    ),
    ConfigEntry(
        ...
        scope="env-var",
        environment="dev",
        description="Azure blob container used by the OVH and Azure Terraform remote state backends.",
        required_by=("run-ovh-terraform-reinstall.yml", "run-azure-terraform.yml"),
    ),
    ConfigEntry(
        name="AZURE_APP_TERRAFORM_STATE_KEY",
        scope="env-var",
        environment="dev",
        description="Optional Azure blob name for the Azure Terraform remote state file.",
        required_by=("run-azure-terraform.yml",),
    ),
    ConfigEntry(

...
from enterprise_rag.domain.elements.models import DocumentElement, TableElement
...
from enterprise_rag.domain.multimodal.schemas import TableEnrichmentResult

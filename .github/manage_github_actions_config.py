...
WORKFLOW_ENTRIES: tuple[ConfigEntry, ...] = (
    ...
    ConfigEntry(
        ...
        scope="env-secret",
        environment="dev",
        description="SSH private key for Kubernetes master access.",
        required_by=(
            "run-k8s-addons-bootstrap.yml",
            "run-api-kubernetes-deploy.yml",
            "run-web-kubernetes-deploy.yml",
        ),
    ),
    ConfigEntry(
        ...
        scope="env-secret",
        environment="dev",
        description="Preferred shared SSH private key for Kubernetes cluster deploy workflows.",
        required_by=("run-kubernetes-cluster-deploy.yml",),
    ),
    ConfigEntry(
        name="K8S_WORKER_SSH_PRIVATE_KEY",
        scope="env-secret",
        environment="dev",
        description="SSH private key for Kubernetes worker access.",
        required_by=("run-kubernetes-cluster-deploy.yml",),
    ),
    ConfigEntry(

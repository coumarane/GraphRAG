...
from graph_rag.domain.chunks.vectors import VectorSearchHit, VectorSearchRequest
...
from graph_rag.domain.models.protocols import EmbeddingModel, Reranker
...
from graph_rag.domain.retrieval.intent import QueryAnalysis, analyze_query
...
class RetrieveEvidenceService:
    ...
    async def retrieve(
        ...
        from graph_rag.infrastructure.observability import get_metrics, start_span

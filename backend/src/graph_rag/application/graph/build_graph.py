...
from graph_rag.domain.graph.extraction import GraphExtractionResult
from graph_rag.domain.graph.models import (
...
from graph_rag.domain.graph.resolution import EntityResolver
...
from graph_rag.domain.ids import deterministic_id
...
class BuildKnowledgeGraphService:
    ...
    def _semantic_projection(
        ...
        *,
        ...
        from graph_rag.domain.graph.resolution import normalize_entity_name

...
BUILTIN_DOCUMENT_INTELLIGENCE_MODELS: tuple[DocumentIntelligenceModel, ...] = (
    ...
    DocumentIntelligenceModel(
        ...
        fields=[
            ...
            _field("function", "Function", FieldType.LIST, default_selected=True),
            _field(
            ...
            _field("appearance", "Appearance", FieldType.STRING),
            _field("solubility", "Solubility", FieldType.STRING),
            _field("claims", "Claims", FieldType.LIST),
            _field("regulatory_status", "Regulatory status", FieldType.LIST),
            _field("shelf_life", "Shelf life", FieldType.STRING),
        ],
    ),
    DocumentIntelligenceModel(

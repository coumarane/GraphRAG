...
from graph_rag.domain.elements.models import DiagramElement, DocumentElement, ImageElement
...
from graph_rag.domain.multimodal.schemas import ImageEnrichmentResult

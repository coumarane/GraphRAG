...
class ChatConversationModel(Base, TimestampMixin, TenantOwnedMixin):
    ...
    interaction_mode: Mapped[str] = mapped_column(String(16), nullable=False, default="chat")
...
class ChatMessageModel(Base, TimestampMixin, TenantOwnedMixin):
    ...
    interaction_mode: Mapped[str] = mapped_column(String(16), nullable=False, default="search")

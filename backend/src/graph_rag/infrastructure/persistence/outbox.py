...
from graph_rag.domain.ingestion.outbox import OutboxEventRecord
from graph_rag.infrastructure.persistence.postgres.models.outbox import OutboxEventModel
